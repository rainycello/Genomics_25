...
##                                                                      ##
  ...
  $configuration = {
          'CDHIT_DIR' => {
                           ...
                           'required' => 1,
                           'value' => '/home/genomika25/miniconda3/envs/repeatmasker/bin'
                         },
          'GENOMETOOLS_DIR' => {
          ...
          'NINJA_DIR' => {
                           ...
                           'param_type' => 'directory',
                           'required' => 0,
                           'value' => '/home/genomika25/RM/NINJA-1.00-cluster_only/NINJA/'
                         },
          'RECON_DIR' => {
                           ...
                           'param_type' => 'directory',
                           'required' => 1,
                           'value' => '/home/genomika25/RM/RECON-1.08/bin'
                         },
          'REPEATMASKER_DIR' => {
                                  ...
                                  'param_type' => 'directory',
                                  'required' => 1,
                                  'value' => '/home/genomika25/RM/RepeatMasker'
                                },
          'RMBLAST_DIR' => {
                             ...
                             'param_type' => 'directory',
                             'required' => 1,
                             'value' => '/home/genomika25/RM/rmblast-2.14.1/bin'
                           },
          'RSCOUT_DIR' => {
                            ...
                            'param_type' => 'directory',
                            'required' => 1,
                            'value' => '/home/genomika25/RM/RepeatScout-1.0.6'
                          },
          'TRF_DIR' => {
